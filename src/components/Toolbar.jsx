  ...
  const styles = {
    ...
    sim: {
      base: {
        background: "#C4623A",
        color: "#FEF9F6",
        border: "1.5px solid #C4623A",
        boxShadow: "0 2px 8px rgba(196,98,58,0.25)",
      },
...
export default function Toolbar({
  ...
  return (
    ...
    >
      ...
      {/* Divider */}
      <div
        style={{ width: 1, height: 28, background: "#EDE8DF", marginRight: 20 }}
      />
      ...
      <div style={{ display: "flex", gap: 6 }}>
        ...
        <Btn variant="ghost" onClick={onExpandAll}>
          Expand All
        </Btn>
        <Btn variant="ghost" onClick={onCollapseAll}>
          Collapse All
        </Btn>
      </div>
